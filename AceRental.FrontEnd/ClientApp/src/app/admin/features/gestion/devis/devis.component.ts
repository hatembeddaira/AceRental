...
import {AfterViewInit, Component, Inject, PLATFORM_ID, ViewChild, inject} from '@angular/core';
...
@Component({
  ...
  imports: [MatTableModule, MatSortModule, RouterModule,  NgxExtendedPdfViewerModule],
