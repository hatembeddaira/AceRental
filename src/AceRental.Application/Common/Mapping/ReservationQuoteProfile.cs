...
{
    public class ReservationQuoteProfile : Profile
    {
        /// <inheritdoc/>
        public ReservationQuoteProfile()
        {
            CreateMap<Reservation, ReservationQuoteDto>()
                ...
                .ForMember(dest => dest.Workflow, opt => opt.MapFrom(source => source.Workflow))
